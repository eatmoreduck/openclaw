...
/** Agent selection scopes provider access, never the global defaults above it. */
export function renderModelProviderScope(props: {
  ...
  return html`
    ${renderAgentScopeControl({ agents: props.agents, selection: props.agentSelection, allowAll: false, selectedId: props.selectedAgentId })}
    <button
      class="btn"
      data-models-connect
